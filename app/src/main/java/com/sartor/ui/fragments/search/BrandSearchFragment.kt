...
class BrandSearchFragment : Fragment() {
    ...
    private var list: ArrayList<BrandResponse> = ArrayList<BrandResponse>()
    private var filteredList: ArrayList<BrandResponse> = ArrayList<BrandResponse>()
    ...
    private fun search() {
        ...
        binding?.searchView?.setOnQueryTextListener(object : SearchView.OnQueryTextListener {
            ...
            override fun onQueryTextChange(query: String): Boolean {
                ...
                filteredList = ArrayList<BrandResponse>()
