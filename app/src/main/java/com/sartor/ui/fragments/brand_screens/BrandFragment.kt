...
class BrandFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val fragments: ArrayList<Fragment> = arrayListOf(
            ...
            BrandServicePolicyFragment()
        )
        var follow = false
        binding?.btnFollow?.setOnClickListener {
            if(follow){
                follow = false
                binding?.btnFollow?.setImageResource(R.drawable.ic_follow_adds_orange)
            }else{
                follow = true
            //    binding?.btnFollow?.setImageResource(R.drawable.ic_follow_checks_orange)
            }
...
//                    }
//                    2 -> {
//                    tab.setIcon(R.drawable.ic_round_sticky_note_2_24)
//                }
//                }
//            }).attach()
