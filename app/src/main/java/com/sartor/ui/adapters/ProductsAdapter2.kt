...
class ProductsAdapter2(private var list: List<ProductResponse>, private val context: Context) :
    RecyclerView.Adapter<ProductsAdapter2.ViewHolder>() {
    var sp = SharedPreference(context)

    var isFavt = false;

    lateinit var product: ProductResponse
    ...
    private fun updateFavt(holder: ViewHolder, p: ProductResponse, isFavt: Boolean) {
