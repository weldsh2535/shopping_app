...
class ShoppingBagItemAdapter(val list: List<CartItem>, val context: Activity) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.img.placeImage(Constant.BASE_MEDIA + list[position].productImage)
        //Log.i("CARTIMAGE",Constant.BASE_URL + list[position].productImage)

        holder.img.setOnClickListener {
            Navigation.findNavController(this.context, R.id.homeHost).navigate(
