...
/*Blog API*/
    ...
    //get All Brands
    @GET("/api/brands")
    fun getAllBrands() : Call<List<BrandResponse>>
    ...
    //Adding item to bag
    @POST("/api/carts")
    fun addToCart(@Body addToCartRequest: AddToCartRequest ) : Call<AddCartResponse>
...
/*Notification*/
    ...
    fun brandProduct(@Body reviewRequest: JsonObject): Call<List<ProductResponse>>
    ...
    @POST("/api/reviews")
    fun addReview(@Body reviewRequest: MultipartBody): Call<ReviewResponse>
    ...
    fun searchReview(@Body reviewRequest: JsonObject): Call<List<ReviewResponse>>
